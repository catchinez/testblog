...
<main class="blog-post">
    <div class="container">
        ...
        <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{ $date->translatedFormat('F') }} {{ $date->day }}.{{ $date->year }} {{ $date->format('H:i') }} • Featured • <a href="#comments">{{ $post->comments->count() }} Comments</a> </p>
        ...
        <div class="row">
            <div class="col-lg-9 mx-auto">
                ...
                <section class="comment-list mb-5" id="comments">
